    ...
    <div class="table-div">
        ...
        <table class="table">
            <thead class="table-header">
                <tr>
                    <th class="column1">#</th>
                    <th class="column2">نوع</th>
                    <th class="column3">نام فایل</th>
                    <th class="column4">اندازه فایل</th>
                    <th class="column5">عملیات</th>
                </tr>
            </thead>
                    ...
                    <tr>
                        ...
                        <td class="column5">
                            <div class="Buttons">
                                ...
                                <button type="button" class="copy-link" data-clipboard-demo="" data-clipboard-target=".i<?= $copyUrlClass ?>" data-clipboard-action="copy" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="bottom" data-bs-custom-class="custom-popover" data-bs-content="کپی شد!">
                                    <span>کپی کردن</span>
